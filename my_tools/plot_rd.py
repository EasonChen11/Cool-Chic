...
def plot_rd_curves(coolchic_csv_path, use_log_scale=False, show_baselines=True):
    ...
    hevc_csv = os.path.join(target_dir, f"{img_name}_hevc.csv")  # HEVC baseline

    plt.figure(figsize=(10, 7))

    # 1. plot Cool - blue line
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--only-coolchic", action="store_true", help="Plot only Cool-chic"
    )
